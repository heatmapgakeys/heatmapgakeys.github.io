...
$(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (false === response.error) {
                            ...
                            if(typeof datatable_name !== 'undefined' && datatable_name == 'table12') table12.draw('page');
                            if(typeof datatable_name !== 'undefined' && datatable_name == 'table11') table11.draw('page');
                            if(typeof datatable_name !== 'undefined' && datatable_name == 'table10') table10.draw('page');
                            if(typeof datatable_name !== 'undefined' && datatable_name == 'table9') table9.draw('page');
                            if(typeof datatable_name !== 'undefined' && datatable_name == 'table8') table8.draw('page');
                            if(typeof datatable_name !== 'undefined' && datatable_name == 'table7') table7.draw('page');
                            if(typeof datatable_name !== 'undefined' && datatable_name == 'table6') table6.draw('page');
                            if(typeof datatable_name !== 'undefined' && datatable_name == 'table5') table5.draw('page');
                            if(typeof datatable_name !== 'undefined' && datatable_name == 'table4') table4.draw('page');
    ...
    $(document).on('draw.dt','#mytable,#mytable2,#mytable3,#mytable4,#mytable5,#mytable6,#mytable7,#mytable8,#mytable9,#mytable10',function(){
