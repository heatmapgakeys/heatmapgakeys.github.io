...
var monthly_subscriber_gain_chart_bar = new Chart(monthly_subscriber_gain_chart, {
  data: {
    ...
    {
      type: 'line',
      label: local_whatsapp_subscribers_this_year,
      data: whatsapp_subscriber_gain_data_month_data,
      borderColor: '#25D366',
...
var monthly_subscriber_years_pie_chart = new Chart(monthly_subscriber_years_pie, {
  ...
  data: {
    datasets: [{
      data: [subscriber_count_yearly, whatsapp_subscriber_count_yearly],
      backgroundColor: [
        '#0D8BF1',
        '#25D366'
      ],
  ...
  var ecommerce_earning_chart_bar = new Chart(ecommerce_earning_chart, {
    data: {
      ...
      datasets: [{
        ...
        data: total_earning_chart_values,
