...
if(str_contains(env('APP_URL'),'heatsketch.test')) Route::any('webhook/paypal-ipn-action',[WebhookPayment::class,'paypal_ipn_action'])->name('paypal-ipn-action');
...
Route::post('webhook/stripe-ipn/{buyer_user_id}/{parent_user_id}/{package_id}',[WebhookPayment::class,'stripe_ipn'])->name('stripe-ipn');
Route::post('webhook/fastspring-ipn',[WebhookPayment::class,'fastspring_ipn'])->name('fastspring-ipn');

if(str_contains(env('APP_URL'),'heatsketch.test')) Route::any('webhook/paypro-ipn',[WebhookPayment::class,'paypro_ipn'])->name('paypro-ipn');
else Route::post('webhook/paypro-ipn',[WebhookPayment::class,'paypro_ipn'])->name('paypro-ipn');

Route::any('webhook/paypro-ipn-manual-call/'.ENV('CRON_TOKEN'),[WebhookPayment::class,'paypro_ipn'])->name('paypro-ipn-manual-call');
