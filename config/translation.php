    ...
    */
    ...
    'scan_groups'=> [
        'system'=>[
            ...
            '7'=> [
                'path'=>resource_path('views').DIRECTORY_SEPARATOR.'layouts'.DIRECTORY_SEPARATOR.'bare.blade.php',
                'type'=>'view',
                'scan_mode'=>'file'
            ],
            '8'=> [
        ...
        'stat'=>[
            '0'=> [
                'path'=>app_path().DIRECTORY_SEPARATOR.'Http'.DIRECTORY_SEPARATOR.'Controllers'.DIRECTORY_SEPARATOR.'Heatmap',
                'type'=>'controller',
                'scan_mode'=>'directory'
            ],
            '1'=> [
                'path'=>resource_path('views').DIRECTORY_SEPARATOR.'heatmap',
                'type'=>'view',
                'scan_mode'=>'directory'
            ]
        ],        
        ...
        'landing'=>[            
            ...
            '1'=> [
                'path'=>app_path().DIRECTORY_SEPARATOR.'Http'.DIRECTORY_SEPARATOR.'Controllers'.DIRECTORY_SEPARATOR.'Front.php',
                'type'=>'controller',
                'scan_mode'=>'file'
            ],
            '2'=> [
                'path'=>resource_path('views').DIRECTORY_SEPARATOR.'front',
                'type'=>'view',
                'scan_mode'=>'directory'
            ],
            '3'=> [
                'path'=>resource_path('views').DIRECTORY_SEPARATOR.'layouts'.DIRECTORY_SEPARATOR.'front.blade.php',
                'type'=>'view',
                'scan_mode'=>'file'
            ]
        ]
