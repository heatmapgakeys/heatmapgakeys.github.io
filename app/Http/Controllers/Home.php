...
class Home extends BaseController
{
  ...
  protected function set_auth_variables(){
    ...
    protected function viewcontroller($data=array())
    {
        ...
        $data['white_logo'] = 'logo-white.png';
    ...
    protected function site_viewcontroller($data=array())
    {
        ...
        if($data['body'] != 'front.index_install')
        {
            if( Auth::user()){
                $user_type =  Auth::user()->user_type;
                $user_id =  Auth::user()->id;
    ...
    protected function multiple_assign_label($subscriber_id='',$telegram_bot_id=0,$label_auto_ids='',$subscriber_info='')
    {
    ...
    protected function multiple_assign_label_whatsapp($subscriber_id='',$whatsapp_bot_id=0,$label_auto_ids='',$subscriber_info='') 
    {
        $label_auto_ids=explode(",",$label_auto_ids);
        $label_auto_ids=array_filter($label_auto_ids);
