...
if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN'){ // only overwrite on windows platform
    ...
    */    
    function __($key = null, $replace = [], $locale = null)
    {
        ...
        $langFiles = array ('auth','bot','broadcast','dashboard','docs','ecommerce','flowbuilder','guest','landing','livechat','member','misc','pagination','passwords','subscriber','subscription','system','ticket','validation');
