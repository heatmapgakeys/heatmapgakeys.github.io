<form class="form-horizontal" action="" method="POST" id="affiliate-user-form">
    ...
    <div class="card no-border">
            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input name="name" value="<?php echo old('name');?>"  class="form-control" type="text">
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input name="email" value="<?php echo old('email');?>"  class="form-control" type="email">
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input name="mobile" value="<?php echo old('mobile');?>"  class="form-control" type="text">       
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea name="address" id="address" class="form-control"><?php echo old('address');?></textarea>
                    </div> 
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card mt-5">
                        <div class="card-header">
                            <h4><i class="fas fa-gift"></i> <?php echo __('Affiliate Payment'); ?></h4>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group" id="signup_sec_div">
                                        <label class="mb-2" for="signup_amount"><i class="fas fa-briefcase"></i> <?php echo __('Amount'); ?></label>
                                        <div class="input-group">
                                            <div class="input-group-text">
                                                <?php echo $curency_icon??"$"; ?>
                                            </div>
                                            <input type="text" class="form-control" name="signup_amount" id="signup_amount">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="form-check form-switch float-start mt-3">
                                    ...
                                    <div id="payment_sec_div" >
                                        ...
                                        <div class="form-group mt-1" id="fixed_amount_div" >
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="fixed_amount" id="fixed_amount">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-1" id="percentage_div">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="percent_amount" id="percent_amount">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="card-footer px-0 my-2">
            ...
            <button  type="button" class="btn btn-secondary float-end cancel"><i class="fas fa-times"></i> <?php echo __("Cancel");?></button>
        </div>
    </div>
</form>