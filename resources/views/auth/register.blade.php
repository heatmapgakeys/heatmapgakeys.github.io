...
<form method="POST" id="register-form">
    ...
    @if($has_affiliate_access)
    <div class="form-check form-switch mt-3 float-end">
      <input class="form-check-input" name="is_affiliate" type="checkbox" id="is_affiliate" value="1">
      <label class="form-check-label" for="is_affiliate">{{__('Signup as Affiliate')}}</label>
    </div>
    @endif
</form>
@endsection
