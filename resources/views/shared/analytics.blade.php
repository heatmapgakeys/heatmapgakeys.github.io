...
<?php if(isset($get_analytics_code['tme_widget_id']) && !empty($get_analytics_code['tme_widget_id'])) : ?>
<script type="text/javascript" src="{{route('tme-link-js-code-generator')}}?code=<?php echo $get_analytics_code['tme_widget_id'] ?? ""; ?>"></script>
<?php endif; ?>

<?php if(isset($get_analytics_code['whatsapp_widget_id']) && !empty($get_analytics_code['whatsapp_widget_id'])) : ?>
<script type="text/javascript" src="{{route('whatsapp-wa-link-js-code-generator')}}?code=<?php echo $get_analytics_code['whatsapp_widget_id'] ?? ""; ?>"></script>
<?php endif; ?>
