            ...
            <ul>
              ...
              <li>
                  ...
                  <ul>
                      {{__('Main Menu')}}
                      <li>
                          <a href="{{route('docs.install')}}">{{__('How to Install')}}</a>
                      </li>
                      <li>
                        
                      </li>
                      <li>
                          <a href="{{route('docs.live.users')}}">{{__('Live Users')}}</a>
                      </li>
                ...
                <ul>
                    {{__('STATS')}}
                    <li>
                        <a href="{{route('docs.domains')}}">{{__('Domains')}}</a>
                    </li>
                    <li><a href="{{route('docs.heatmaps')}}">{{__('Heatmaps')}}</a></li>
                    <li>
                        <a href="{{route('docs.recordings')}}">{{__('Recordings')}}</a>
                    </li>
              ...
              <li>
                <ul>
                  {{__('Administration')}}
                  <li>
                    <a class="{{'active'}}" href="{{route('docs.settings')}}">{{__('Settings')}}</a>
                  </li>
                    <li>
                        <a href="{{route('docs.user')}}">{{__('User')}}</a>
                    </li>

                    <li>
                        <a href="{{route('docs.package')}}">{{__('Package')}}</a>
                    </li>
                </ul>
              </li>
              ...
              <li>
                <ul>
                    {{__('Payment')}}
                    <li><a href="{{route('docs.transaction')}}">{{__('Transaction')}}</a></li>
                </ul>
              </li>
              ...
              <li>
                <ul>
                    {{__('Update System')}}
                    <li><a href="{{route('docs.update')}}">{{__('Update')}}</a></li>
