                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::select('allowed_domain_ids[]',$website_list,old('allowed_domain_ids'),['class' => 'form-control select2','id'=>'allowed_domain_ids','style'=>'width:100% !important;','multiple'=>'multiple']);?>
