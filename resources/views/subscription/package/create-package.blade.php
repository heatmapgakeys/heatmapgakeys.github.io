                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row <?php echo $action_type!='team' ? 'mt-5' : 'mt-2';?>">
                                                <div class="form-group">
                                                <?php $mandatory_modules = array(); $SL=0; $access_sl=0;?>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="fastspring_product_id" class="form-control" value="{{old('fastspring_product_id')}}">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="fastspring_coupon" class="form-control" value="{{old('fastspring_coupon')}}">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="paypro_product_id" class="form-control" value="{{old('paypro_product_id')}}">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="paypro_coupon" class="form-control" value="{{old('paypro_coupon')}}">
