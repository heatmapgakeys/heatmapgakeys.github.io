...
<div class="main-content container-fluid">
    ...
    <?php
    $fastspring_data = isset($payment_config->fastspring) ? json_decode($payment_config->fastspring) : null;
    $paypro_data = isset($payment_config->paypro) ? json_decode($payment_config->paypro) : null;
    $fastspring_access = isset($fastspring_data->fastspring_status) && $fastspring_data->fastspring_status=='1' ? true : false;
    $paypro_access = isset($paypro_data->paypro_status) && $paypro_data->paypro_status=='1' ? true : false;
    ...
    $integration_access = $paypal_access || $paypro_access || $fastspring_access ? true : false;
                                                                ...
                                                                <td class='text-center {{$action_type!="team" ? "d-none" : ""}}'>
                                                                    @foreach($access_array as $access_key=>$access_value)
                                                                        <?php
                                                                            $access_sl++;
                                                                            $checked = '';
                                                                            //if(in_array($module->id,$mandatory_modules) && in_array($access_key,[1,2])) $checked='checked';
                                ...
                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="fastspring_product_id" class="form-control" value="{{old('fastspring_product_id',$product_data->fastspring->product_id??'')}}">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="fastspring_coupon" class="form-control" value="{{old('fastspring_coupon',$product_data->fastspring->coupon??'')}}">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="paypro_product_id" class="form-control" value="{{old('paypro_product_id',$product_data->paypro->product_id??'')}}">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="paypro_coupon" class="form-control" value="{{old('paypro_coupon',$product_data->paypro->coupon??'')}}">
                                    ...
                                    <div class="col-4 <?php echo !$integration_access ? 'd-none' : '';?>">
                                        <div class="nav d-block nav-pills h-max-350px overflow-y" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            ...
                                            <a class="nav-link" data-bs-toggle="pill" href="#fastspring-block" role="tab" aria-controls="" aria-selected="true">FastSpring</a>
                                            <a class="nav-link" data-bs-toggle="pill" href="#paypro-block" role="tab" aria-controls="" aria-selected="true">PayPro</a> 
