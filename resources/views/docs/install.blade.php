...
<div class="main-content" style="min-height: 352px">
    <section class="section">
      <div class="section-body">
        ...
        <iframe width="850" height="415" src="https://www.youtube.com/embed/0-wnawoAedI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <br><br><br>
        <b id="server-config">{{__("Server Configuration")}} :</b><br><br>
        <ul>
          <li>
            PHP >= 7.4 <br> MySQL >= v5.7.8</li>
          <li>
          ...
          <li class="text-warning"><b>{{__("Your domain must have SSL enabled.")}}</b></li>
          <li>{{__("For better performance set the below configurations as long as possible, so that your server can process script for long time if needed.")}} :  php <b>max_execution_time</b>, mysql <b>connect_timeout</b>, mysql <b>wait_timeout</b> , <b>max_allowed_packet</b> , <b>max_connections</b></li>
        ...
        <img
          src="{{asset("assets/docs/heatsketch_images/install.png")}}"
          class="img-fluid"
        />
      </div>
