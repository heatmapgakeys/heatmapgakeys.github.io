  ...
  <div class="container">
    <div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
      <div class="ud-about-content-wrapper">
          <h4 class="mb-4">{{__('What is GDPR?')}}</h4>
          <p>
          ...
          <h4 class="my-4 pt-4">{{__('Definition of Personal Data')}}</h4>
          <p>
          ...
          <h4 class="my-4 pt-4">{{__('Supported GDPR Features')}}</h4>
          <p>
