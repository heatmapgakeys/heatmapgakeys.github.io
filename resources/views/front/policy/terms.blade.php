  ...
  <div class="container">
    <div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
      <div class="ud-about-content-wrapper">
          ...
          <h4 class="my-4">{{__('Intellectual property rights')}}</h4>
          <p>
          ...
          <h4 class="my-4">{{__('Site management')}}</h4>
          <p>
          ...
          <h4 class="my-4">{{__('Term and termination')}}</h4>
          <p>
          ...
          <h4 class="my-4">{{__('Notice')}}</h4>
          <p>{{__('No additional notice of any kind for any reason is required to be given to visitor and visitor expressly warrants an understanding that the right to notice is waived as a condition for permission to view or interact with the website.')}}</p>
