    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-first">
                <h3>{{ __('Affiliate Settings') }} </h3>
                <p class="text-subtitle text-muted">{{ __('Customize Affiliate Settings') }}</p>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                            <div class="nav nav-pills flex-row justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical" >
                                <button class="rounded-pill nav-link active " id="v-pills-users-tab" data-bs-toggle="pill" data-bs-target="#v-pills-users" type="button" role="tab" aria-controls="v-pills-users" aria-selected="true">{{ __("Users") }}</button>
                                 <button class="rounded-pill nav-link" id="v-pills-user-request-tab" data-bs-toggle="pill" data-bs-target="#v-pills-user-request" type="button" role="tab" aria-controls="v-pills-user-request" aria-selected="true">{{ __("Users Request") }}</button>

                                <button class="rounded-pill nav-link" id="v-pills-withdrawals-tab" data-bs-toggle="pill" data-bs-target="#v-pills-withdrawals" type="button" role="tab" aria-controls="v-pills-withdrawals" aria-selected="false">{{ __("Withdrawal Requests") }}</button>
                                
                                <button class="rounded-pill nav-link" id="v-pills-commission-tab" data-bs-toggle="pill" data-bs-target="#v-pills-commission" type="button" role="tab" aria-controls="v-pills-commission" aria-selected="false">{{ __("Commission Settings") }}</button>
                            </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class='table table-hover table-bordered table-sm w-100' id="mytable1" >
                                                    ...
                                                    <tr class="table-light">
                                                        ...
                                                        <th>{{__("Name") }}</th>
                                                        <th>{{__("Email") }}</th>
                                                        <th>{{__("Referal Users") }}</th>
                                                        <th>{{__("Available Balance") }}</th>
                                                        <th>{{__("Approved  Withdrawal") }}</th>
                                                        <th>{{__("Pending Withdrawal") }}</th>
                                                        <th>{{__("Actions") }}</th>
                                                        <th>{{__("Last IP") }}</th>
                                                    </tr>
                                                    </thead>
...
<link rel="stylesheet" href="{{ asset('assets/css/settings-affiliate.css') }}">
