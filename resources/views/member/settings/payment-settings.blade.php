@extends( ($iframe) ? 'layouts.iframe' : 'layouts.auth')
...
@section('content')
    <div class="main-content <?php echo isset($iframe) && $iframe ? '' : 'container-fluid'?>">
        ...
        <section class="section">
                            ...
                            <div class="card-body">
                                <div class="row">
                                        <div class="col-8">
                                             ...
                                             @if(license_check_action()=='double')
                                                <div class="tab-pane fade active show" id="paypal-block" role="tabpanel" aria-labelledby="">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 <?php echo Request::segment(3) == "0" ? '' : 'd-none';?>">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <span class="input-group-text pt-2 w-100 bg-white">
                                                                            <div class="form-check form-switch">
                                                                                <input class="form-check-input" id="paypal_payment_type" name="paypal_payment_type" type="checkbox" value="recurring" <?php echo old('paypal_payment_type',$paypal_payment_type)=='recurring' ? 'checked' : ''; ?>>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <?php echo Form::select('mercadopago_country',get_marcadopago_country_list(),old('mercadopago_country', $mercadopago_country),array('class'=>'form-control select2'));?>
                                            ...
                                            @endif
                                               <div class="tab-pane fade <?php if(license_check_action()!='double') echo 'active show';?>" id="manual-block" role="tabpanel" aria-labelledby="">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <a class="nav-link <?php if(license_check_action()!='double') echo 'active';?>" data-bs-toggle="pill" href="#manual-block" role="tab" aria-controls="" aria-selected="true">{{__('Manual')}}</a >
                                            </div>
                                        </div>
                                    </div>
                            </div>
            ...
            @if($is_admin && Request::segment(3) == "0"  && license_check_action() =='double')
...
@push('styles-footer')
<link rel="stylesheet" href="{{ asset('assets/css/payment-set.css') }}">
