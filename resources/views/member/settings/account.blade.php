...
<div class="main-content container-fluid">
	...
	<section id="basic-horizontal-layouts">
        ...
        <div class="row match-height">
            <div class="<?php echo $is_admin ? 'col-lg-6 offset-lg-3 col-md-12 col-12' : 'col-lg-5 col-md-12 col-12'?>">
                <div class="card">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-12">
                                                    <?php $show_pic  = ($show_pic != '') ? asset('storage/app/public/assets/profile/'.$user_id.'/'.$show_pic) : asset('assets/images/profile_pic.png'); ?>
                                                    <div class="row">
                                                        <div class="col-4 col-md-2"><img src="{{ $show_pic }}" width="70" height="70" class="border rounded-circle" alt="">
                                                        </div>
