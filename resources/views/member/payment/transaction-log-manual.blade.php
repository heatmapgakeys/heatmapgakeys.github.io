    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><i class="fas fa-times-circle" id="a-times-circ"></i> <?php echo __("Manual payment rejection");?></h5>
              ...
              <div class="form-group">
                ...
                <div id="manual-payment-dropzone" class="dropzone mb-1">
                  <div class="dz-default dz-message">
                    ...
                    <span id="spanid_id"><i class="fas fa-cloud-upload-alt" id="fa-c_loud-u"></i> <?php echo __('Upload'); ?></span>
                  </div>
                </div>
