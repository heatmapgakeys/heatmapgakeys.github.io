            ...
            @if($is_admin || $is_agent)
                ...
                <div class="row ">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card card-icon-bg-md" id="card_card-ic">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <img id="me_2_id" class="me-2" data-bs-toggle="tooltip" src="{{asset('assets/vendors/flag-icon-css/flags/4x3').'/'.strtolower($key)}}.svg" alt="{{strtolower($key)}}" width="60" height="45">
                                            <div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        {    if(strtolower($key)=='uk') $key='GB';?>
                                        <div class="d-flex align-items-center mb-2">
                                            <img id="me_2_img_id" class="me-2" data-bs-toggle="tooltip" src="{{asset('assets/vendors/flag-icon-css/flags/4x3').'/'.strtolower($key)}}.svg" alt="{{strtolower($key)}}" width="60" height="45">
                                            <div>
                                                <div class="fs-6 text-dark fw-bold"><?php echo '<b>'.$currency_icon.convert_number_numeric_phrase($value).'</b>'; ?></div>
                                                <div class="fs-6 text-muted"><?php echo isset($country_names[$key]) ? __($country_names[$key]) : "-"; ?></div>
                                            </div>
