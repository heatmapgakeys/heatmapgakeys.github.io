        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="form-group">
              ...
              &nbsp;
              <textarea name="additional-info" id="additional-info" class="form-control" style="height: 210px;"></textarea>
            </div>
          </div>
        </div>
      </div><!-- ends modal-body -->
...
@if($fastspring_status=='1')
    @push('scripts-footer')
        <script
            id="fsc-api"
            src="{{$fastspring_api_src}}"
            type="text/javascript"
            data-storefront="{{$fastspring_store_front}}"
            data-popup-webhook-received="dataPopupWebhookReceived"
            data-popup-closed="dataPopupClosed">
        </script>
        <script src="{{ asset('assets/js/pages/member/payment.buy-package.js') }}"></script>
    @endpush
@endif
