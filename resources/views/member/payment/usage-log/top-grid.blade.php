...
@foreach($subscription_data_formated as $k => $data)
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="card card-icon-bg-md border-light box-shadow pb-0" style="min-height: 100px;border-style: dashed;border-width: .5px;border-radius: 10px;">
            <div class="card-body bg-light ps-4 pe-2" style="border-radius:10px;">
                <div class="row">
                    <div class="col">
